...
$testCases = [
    ...
    // Additional complex cases with multiple levels of nesting
    ...
    'order(id,items(id,product(id,name,category(id,name))))' =>
    'order.id,order.items.id,order.items.product.id,order.items.product.name,order.items.product.category.id,order.items.product.category.name',
];
...
echo "Testing nested bracket to dot notation transformation:\n";
echo "==================================================\n";
